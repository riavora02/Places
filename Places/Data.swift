...
var review1 = Review(user: "Ria V.", review: "This was a great vending machine. A perfect place to grab a snack when I needed a study break.", rating: 4, placeTag: 1)
var review2 = Review(user: "Ria V.", review: "This was a great vending machine. A perfect place to grab a snack when I needed a study break.", rating: 4, placeTag: 1)
var review3 = Review(user: "Ria V.", review: "This was a great vending machine. A perfect place to grab a snack when I needed a study break.", rating: 4, placeTag: 1)
var review4 = Review(user: "Ria V.", review: "This was a great vending machine. A perfect place to grab a snack when I needed a study break.", rating: 4, placeTag: 1)
var review5 = Review(user: "Ria V.", review: "This was a great vending machine. A perfect place to grab a snack when I needed a study break.", rating: 4, placeTag: 1)
